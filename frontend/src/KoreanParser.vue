    ...
    <div id="app" v-on:mouseup="appMouseUp($event)">
        <div class="k-flexcol">
            ...
            <div id="input-row" class="k-flexrow ">
                ...
                <div id="attribution">v0.7.6 - <a href="mailto:johnw3d@gmail.com">JBW</a> - based on the <a href="https://github.com/kakao/khaiii">Kakao Hangul Analyzer III</a> and JBW's phrase parser</div>
            </div>
            <!-- input row -->
            <div class="k-flexrow">
                <table>
...
export default {
	...
	methods: {
        ...
        leafTagClass: function(node) {
            ...
            return node.tag[0] == 'N' || node.tag[0] == 'V' || node.tag[0] == 'M' ? "leaf-tag-def" : "leaf-tag";
        },
